 ...
 * 
 */
public class ContactAdapter extends ArrayAdapter<Music> implements SectionIndexer  {
...
//
	...
	public ContactAdapter(Context context, int resource, List<Music> objects) {
        super(context, resource, objects);
        this.res = resource;
//        this.userList = objects;
//        copyUserList = new ArrayList<Music>();
