...
import com.example.laibomusic.util.DisplayUtil;
...
public class Sidebar extends View{
	...
	private void setHeaderTextAndscroll(MotionEvent event){
		...
		AlllistAdapter   adapter =   (AlllistAdapter) ha.getWrappedAdapter();
		//adapterSections要获取
		String[] adapterSections =  adapter.getSectionString();
	...
	public boolean onTouchEvent(MotionEvent event) {
		switch (event.getAction()) {
			case MotionEvent.ACTION_DOWN:{
				...
				if(header == null)Log.d("TAG"," header view is null object");
